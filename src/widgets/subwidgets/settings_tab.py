...
class SettingTab(QWidget):
    def __init__(self):
        ...
        self.error_loading_wait_time = QLineEdit()
        self.time_out_edit.setFixedWidth(stc.TEXT_EDIT_WIDTH)
        self.line_one_layout.addRow(stc.ERROR_LOADING_WAIT_TIME_TEXT, self.error_loading_wait_time)
        self.error_loading_wait_time.setFixedWidth(stc.TEXT_EDIT_WIDTH)
        ...
        self.error_loading_wait_time.setText(setting.get(spc.ERROR_TIME_OUT))
